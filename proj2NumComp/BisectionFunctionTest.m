%This function takes in the function, the interval from [a,b] and gives the
%option of 1,2,3, for the errors, ofcourse to then calculate the root
...
for i=1:10
    ...
    if aae <= threshold
        ...
        fprintf('%i             %.6f    %.6f    %.6f      %.6f     %.6f\n', count,x1,x2,mean,root,fproduct);
